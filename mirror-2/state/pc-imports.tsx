...
export const pcImportsApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    updatePcImport: builder.mutation<
      Database['public']['Tables']['pc_imports']['Row'],
      {
        id: string
        updateData: Partial<
          Database['public']['Tables']['pc_imports']['Update']
        >
      }
    >({
      ...
      invalidatesTags: (result, error, { id: importId }) => [
        { type: 'PcImports', id: importId }
      ]
    }),

    deletePcImport: builder.mutation<
      Database['public']['Tables']['pc_imports']['Row'],
      string
    >({
      queryFn: async (importId) => {
      ...
      invalidatesTags: (result, error, importId) => [
        { type: 'PcImports', id: importId }
      ]
    })
  })
