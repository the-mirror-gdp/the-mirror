...
export class UserFeedbackItemBugPublicData extends UserFeedbackItemPublicData {}

export type UserFeedbackItemBugDocument = UserFeedbackItemBug & Document
