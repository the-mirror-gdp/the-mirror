...
func convert_gameplay_value_for_ui() -> float:
	return db_to_linear(GameplaySettings.menu_ambience_volume_db) * 100.0


func apply_setting_to_gameplay() -> void:
	GameplaySettings.menu_ambience_volume_db = linear_to_db(_number_slider.current_value / 100.0)
